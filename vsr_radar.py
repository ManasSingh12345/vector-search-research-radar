...
# ----------------------------------------------------------------------------
METHOD = [
    ("graph",    "Graph / Tree Indexes",          ["hnsw","navigable small world","proximity graph","graph-based","graph index","nsg","diskann","vamana","cagra","knn graph","greedy search graph","k-d tree","kd-tree","kd tree","ball tree","r-tree","cover tree","metric tree","metric space","reverse k-nearest","reverse nearest","skiplist"]),
    ("quant",    "Quantization & Compression",    ["product quantization","quantization","quantize","rabitq","scalar quantization","binary embedding","binary code","binary quantization","compression","codebook","residual quantization","opq","low-bit"]),
    ...
    ("scale",    "Billion-Scale / Disk",          ["billion-scale","billion scale","disk-based","disk based","ssd","out-of-core","memory-efficient","web-scale","trillion","external memory","disk-oblivious"]),
    ("filter",   "Filtered Search",               ["filtered search","filtered ann","attribute filter","predicate","metadata filter","constrained nearest","range filter","label filter","filter-aware","filter-agnostic","arbitrary-filtered"]),
    ...
    ("multivec", "Multi-Vector / Late Interaction",["colbert","late interaction","multi-vector","multi vector","token-level retrieval","maxsim","plaid"]),
